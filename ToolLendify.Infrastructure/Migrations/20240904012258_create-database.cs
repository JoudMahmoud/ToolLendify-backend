    ...
    public partial class createdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalTool", x => new { x.RentalsId, x.toolsId });
                    table.ForeignKey(
                        name: "FK_RentalTool_Rentals_RentalsId",
                        column: x => x.RentalsId,
                        principalTable: "Rentals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_RentalTool_Tools_toolsId",
                        column: x => x.toolsId,
